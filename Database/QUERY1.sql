-- 1. Create Database
CREATE DATABASE MaiAmTruyenTinManagement ON  PRIMARY 
	( NAME = 'MaiAmTruyenTinManagement', 
	FILENAME = 'G:\Learning\Service Learning\Mái Ấm Truyền Tin Website\MaiAmTruyenTin\MaiAmTruyenTinManagement.mdf' , 
	SIZE = 3072KB ,
	MAXSIZE = UNLIMITED, 
	FILEGROWTH = 1024KB )
 LOG ON 
	( NAME = 'MaiAmTruyenTinManagement_log', 
	FILENAME = 'G:\Learning\Service Learning\Mái Ấm Truyền Tin Website\MaiAmTruyenTin\MaiAmTruyenTinManagement_log.ldf' , 
	SIZE = 1024KB , 
	MAXSIZE = 2048KB , 
	FILEGROWTH = 10%)
GO
USE MaiAmTruyenTinManagement
GO
SET ANSI_NULLS ON
GO
